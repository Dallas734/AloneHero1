...
class Entity
{
	...
	public:
		...
		double GetStrength();
		virtual void GetMessage(Message& message) = 0;
	...
	protected:
		...
		States Damage(float time, double xBeginSprite, double yBeginSprite, double width, double height, int frames, double damage, Directions direction); // Получение урона
