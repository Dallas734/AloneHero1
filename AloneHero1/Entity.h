...
class Entity
{
	...
	public:
		...
		FloatRect getRect();
	protected:
		States Hit(float time, double xBeginSprite, double yBeginSprite, double width, double height, double buf, int frames, double strength, Directions direction, RenderWindow& window, Entity* entety); // Удар
